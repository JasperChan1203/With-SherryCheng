#!/usr/bin/env python3
"""Quick test of LiH validation with minimal episodes."""
...
print("Running LiH validation with active_space=(2,3), Jordan-Wigner transform")
print("n_episodes=10 (just to see baseline)")
results = run_lih_validation(
    ...
    n_episodes=10,
    early_stop_threshold=1.0,  # large threshold to not stop early
    output_dir='./temp_lih_results_jw',
...
import shutil
if os.path.exists('./temp_lih_results_jw'):
    shutil.rmtree('./temp_lih_results_jw')
