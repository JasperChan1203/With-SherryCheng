...
def test_circuit_builder(data):
    ...
    try:
        ...
        if excitations:
            ...
            # Initialize parameters for all excitations (builder.n_params)
            params = builder.initialize_parameters(builder.n_params, strategy="random")
            circuit = builder.build_circuit(single_exc, params)
...
def test_agent():
    ...
    try:
        ...
        from rlqas.phase1.rl.config import AgentConfig
        config = {}
