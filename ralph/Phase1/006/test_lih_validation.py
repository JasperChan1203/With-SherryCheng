...
print("Running LiH validation with active_space=(2,3), parity transform")
...
import shutil
if os.path.exists('./temp_lih_results'):
    shutil.rmtree('./temp_lih_results')
