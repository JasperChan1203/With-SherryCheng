...
phase1_src = os.path.join(os.path.dirname(__file__), '..', '..', '..', '..', 'Phase1', '006', 'src')
phase1_src = os.path.abspath(phase1_src)

phase2_src = os.path.join(os.path.dirname(__file__), '..', 'src')
phase2_src = os.path.abspath(phase2_src)
