...
class DQNDiagnosticsCallback(BaseCallback):
    ...
    def summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "overall_pass": bool(q_loss_trend_pass and exploration_decay_pass and energy_trend_pass),
        }
