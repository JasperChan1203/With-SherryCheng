#!/bin/bash
#SBATCH --job-name=rlqas-hybrid-val-ppo
#SBATCH --output=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/hybrid_search/slurm_logs/val_hybrid_ppo_%j.out
#SBATCH --error=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/hybrid_search/slurm_logs/val_hybrid_ppo_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
WORKDIR="/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/hybrid_search"
...
echo "=== RLQAS LiH Hybrid PPO Validation ==="
...
$PYTHON validate_lih_hybrid_ppo.py \
    --episodes "$EPISODES" \
    --output "results/hybrid_ppo_lih_validation_${SLURM_JOB_ID}.json"
