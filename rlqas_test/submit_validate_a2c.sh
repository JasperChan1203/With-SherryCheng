...
#SBATCH --output=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/slurm_logs/a2c_validate_%j.out
#SBATCH --error=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/slurm_logs/a2c_validate_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
