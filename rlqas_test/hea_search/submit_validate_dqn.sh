#!/bin/bash
#SBATCH --job-name=rlqas-hea-val-dqn
#SBATCH --output=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/hea_search/slurm_logs/val_dqn_%j.out
#SBATCH --error=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/hea_search/slurm_logs/val_dqn_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "=== RLQAS LiH HEA DQN Learning Validation ==="
...
$PYTHON validate_lih_dqn.py \
    --episodes "$EPISODES" \
    --output "results/dqn_lih_hea_validation_${SLURM_JOB_ID}.json"
