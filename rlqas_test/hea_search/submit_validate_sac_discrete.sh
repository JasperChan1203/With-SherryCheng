#!/bin/bash
#SBATCH --job-name=rlqas-hea-val-sac
#SBATCH --output=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/hea_search/slurm_logs/val_sac_%j.out
#SBATCH --error=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/hea_search/slurm_logs/val_sac_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "=== RLQAS LiH HEA SAC-Discrete Learning Validation ==="
...
$PYTHON validate_lih_sac_discrete.py \
    --episodes "$EPISODES" \
    --output "results/sac_discrete_lih_hea_validation_${SLURM_JOB_ID}.json"
