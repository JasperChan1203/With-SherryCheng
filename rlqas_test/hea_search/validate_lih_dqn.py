#!/usr/bin/env python3
"""
LiH HEA DQN Learning Validation
=================================
Validates that the DQN agent in RLQAS can learn an HEA architecture that
...
Usage:
  python validate_lih_dqn.py [--episodes 500] [--output results/dqn_lih_hea_validation.json]
"""
...
def run_validation(n_episodes: int, output_path: str):
    print("=" * 60)
    print("RLQAS LiH HEA DQN Learning Validation")
    ...
    print("\n" + "=" * 60)
    print("DQN HEA VALIDATION SUMMARY")
    print("=" * 60)
...
def main():
    ...
    parser.add_argument('--output', default='results/dqn_lih_hea_validation.json')
