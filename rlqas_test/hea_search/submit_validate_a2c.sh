#!/bin/bash
#SBATCH --job-name=rlqas-hea-val-a2c
#SBATCH --output=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/hea_search/slurm_logs/val_a2c_%j.out
#SBATCH --error=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/hea_search/slurm_logs/val_a2c_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "=== RLQAS LiH HEA A2C Learning Validation ==="
...
$PYTHON validate_lih_a2c.py \
    --episodes "$EPISODES" \
    --output "results/a2c_lih_hea_validation_${SLURM_JOB_ID}.json"
