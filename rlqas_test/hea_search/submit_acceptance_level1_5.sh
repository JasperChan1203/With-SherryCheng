#!/bin/bash
#SBATCH --job-name=rlqas-hea-level1-5
#SBATCH --output=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/hea_search/slurm_logs/hea_level1_5_%j.out
#SBATCH --error=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/hea_search/slurm_logs/hea_level1_5_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "=== RLQAS HEA Acceptance Test - Level 1-5 ==="
...
$PYTHON rlqas_acceptance_system/hea_algorithms/test_acceptance_hea_level1_5.py \
    --agent "$AGENT"
