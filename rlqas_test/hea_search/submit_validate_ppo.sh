#!/bin/bash
#SBATCH --job-name=rlqas-hea-val-ppo
#SBATCH --output=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/hea_search/slurm_logs/val_ppo_%j.out
#SBATCH --error=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/hea_search/slurm_logs/val_ppo_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "=== RLQAS LiH HEA PPO Learning Validation ==="
...
$PYTHON validate_lih_ppo.py \
    --episodes "$EPISODES" \
    --output "results/ppo_lih_hea_validation_${SLURM_JOB_ID}.json"
