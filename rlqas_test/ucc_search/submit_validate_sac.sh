#!/bin/bash
#SBATCH --job-name=rlqas-sac-validate
#SBATCH --output=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/ucc_search/slurm_logs/sac_validate_%j.out
#SBATCH --error=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/ucc_search/slurm_logs/sac_validate_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "=== RLQAS LiH SAC-Discrete Learning Validation ==="
...
$PYTHON validate_lih_sac.py \
    --episodes "$EPISODES" \
    --output "results/sac_lih_validation_${SLURM_JOB_ID}.json" \
    --diag   "results/sac_lih_diagnostics_${SLURM_JOB_ID}.json"
