#!/bin/bash
#SBATCH --job-name=rlqas-ddqn-validate
#SBATCH --output=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/ucc_search/slurm_logs/double_dqn_validate_%j.out
#SBATCH --error=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/ucc_search/slurm_logs/double_dqn_validate_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "=== RLQAS LiH Double-DQN Learning Validation ==="
...
$PYTHON validate_lih_double_dqn.py \
    --episodes "$EPISODES" \
    --output "results/double_dqn_lih_validation_${SLURM_JOB_ID}.json"
