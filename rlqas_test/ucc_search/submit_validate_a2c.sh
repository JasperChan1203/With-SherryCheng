#!/bin/bash
#SBATCH --job-name=rlqas-a2c-validate
#SBATCH --output=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/ucc_search/slurm_logs/a2c_validate_%j.out
#SBATCH --error=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/ucc_search/slurm_logs/a2c_validate_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "=== RLQAS LiH A2C Learning Validation ==="
...
$PYTHON validate_lih_a2c.py \
    --episodes "$EPISODES" \
    --output "results/a2c_lih_validation_${SLURM_JOB_ID}.json" \
    --diag   "results/a2c_lih_diagnostics_${SLURM_JOB_ID}.json"
