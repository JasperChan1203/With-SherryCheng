...
#SBATCH --output=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/ucc_search/slurm_logs/test_%j.out
#SBATCH --error=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/ucc_search/slurm_logs/test_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SCRIPT_DIR="/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/ucc_search"
cd "$SCRIPT_DIR"
