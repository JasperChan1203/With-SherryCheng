...
Usage:
  python validate_lih_ppo.py [--episodes 2000] [--output results/ppo_lih_validation.json]
"""
...
def run_validation(n_episodes: int, output_path: str, diag_path: str):
    print("=" * 60)
    print(f"RLQAS LiH PPO Learning Validation")
    ...
    print("\n" + "=" * 60)
    print("PPO LEARNING DIAGNOSTICS SUMMARY")
    print("=" * 60)
...
def main():
    ...
    parser.add_argument('--output',   default='results/ppo_lih_validation.json')
    parser.add_argument('--diag',     default='results/ppo_lih_diagnostics.json')
