#!/bin/bash
#SBATCH --job-name=rlqas-grpo-validate
#SBATCH --output=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/ucc_search/slurm_logs/grpo_validate_%j.out
#SBATCH --error=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/ucc_search/slurm_logs/grpo_validate_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "=== RLQAS LiH GRPO Learning Validation ==="
...
$PYTHON validate_lih_grpo.py \
    --episodes "$EPISODES" \
    --output "results/grpo_lih_validation_${SLURM_JOB_ID}.json" \
    --diag   "results/grpo_lih_diagnostics_${SLURM_JOB_ID}.json"
