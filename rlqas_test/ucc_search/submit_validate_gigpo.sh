#!/bin/bash
#SBATCH --job-name=rlqas-gigpo-validate
#SBATCH --output=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/ucc_search/slurm_logs/gigpo_validate_%j.out
#SBATCH --error=/curie-home/jpchen/scratch/LLM/code/RLQAS/rlqas_test/ucc_search/slurm_logs/gigpo_validate_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "=== RLQAS LiH GiGPO Learning Validation ==="
...
$PYTHON validate_lih_gigpo.py \
    --episodes "$EPISODES" \
    --output "results/gigpo_lih_validation_${SLURM_JOB_ID}.json" \
    --diag   "results/gigpo_lih_diagnostics_${SLURM_JOB_ID}.json"
